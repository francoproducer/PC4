...
col1.image("1.jpeg", caption='Franco Ricra, fundador de New Mirror', width=300)
...
texto = "Soy un guionista en formación apasionado por la escritura y el cine."
...
st.markdown("<h2 style='text-align: center;'>Fundé mi productora gracias al curso Pensamiento Computacional 💻</h2>", unsafe_allow_html=True)
...
texto_2 = "Al principio, me sentía confundido y un poco intimidado porque todo parecía muy técnico y complicado. Sin embargo, con el tiempo descubrí que se trata de práctica y paciencia."
...
enlace_2 = f'<a href="https://www.youtube.com/watch?v=IA9xcCuR7So" target="_blank"><button>Nombre creativo para el botón</button></a>'
